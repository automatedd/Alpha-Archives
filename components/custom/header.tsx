        ...
        <header className={cn("fixed top-0 md:pt-4 left-0 z-50 w-full", className)}>
            <div className="max-w-5xl mx-auto bg-white p-1 md:rounded-full flex items-center">
                ...
                <div className="ml-auto">
                    <Link href={"/book-now"} className="py-1 cursor-pointer group pr-1 pl-3 md:pl-6 rounded-full border-2 border-yellow-500 bg-linear-to-r flex items-center from-yellow-500 text-black via-yellow-500 to-yellow-950 shadow-xl shadow-amber-500/30">
                        <span className="md:text-lg font-semibold">
                            Work with us
                        </span>
                        <span className="size-10 md:size-12 flex rounded-full bg-white ml-8 md:ml-15">
